...
// Same structure as AdaptiveAdmission (own saturation detector, same plugin interface),
...
//
// Purpose: deploy alongside AdaptiveAdmission as a control group to isolate the effect
// of preemptive shedding vs the plugin framework itself.
//
...
// Identical to saturation() in admission.go and GAIE's utilization/detector.go.
