...
|---|---|---|
| `--max-concurrency` | 3000 | **Required.** Default 256 is too low — causes client-side queueing that throttles actual server QPS. Sized for worst case: 140 QPS × 20s p99 E2E = 2,800 concurrent. Pod ulimit is ~1M file descriptors, so 3000 is safe. |
